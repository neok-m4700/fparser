...
class PreProcessor(Statement):
    """preprocessing, see software.intel.com/en-us/node/524749"""
    match = re.compile(r'#(define|undef|ifdef|ifndef|if|elif|else|endif|include|error|warning|line)', re.I).match
